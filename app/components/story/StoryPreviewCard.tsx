...
export default function StoryPreviewCard({ title, content }: StoryPreviewCardProps) {
  ...
  // TODO: If you want to conditionally render the purple or orange gradient, add a prop or logic here.
  // For now, apply the purple gradient as the default for visual validation.
  // Purple: #703CEC (dark) to #9093F3 (light)
  // Orange: #E74646 (dark) to #EB8888 (light)
  return (
    <div className="relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-[linear-gradient(135deg,#703CEC,#9093F3)] p-5 shadow-[0_18px_50px_rgba(112,60,236,0.12)] sm:p-6">
      <div className="absolute left-0 top-0 h-24 w-24 rounded-full bg-[#703CEC]/25 blur-2xl" />
      <button
        onClick={handleCopy}
